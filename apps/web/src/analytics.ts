...
export type EventName = 'game_view' | 'share' | 'open_steam' | 'unmute' | 'media_swipe' | 'expand_description' | 'open_about' | 'toggle_info' | 'save' | 'unsave' | 'open_saved' | 'open_filter' | 'filter_change'
